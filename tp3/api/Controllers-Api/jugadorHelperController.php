...
require_once 'api/Model-Api/loginModel.php';
class jugadorHelpers extends controller{
    ...
    function login() {
        ...
        $basic = $this->user->getUserHelpers(); // Darnos el header 'Authorization:' 'Basic: base64(usr:pass)'
        if(empty($basic)) {
        ...
        if($user && password_verify($pass, $user->password)){
            ...
            $token = $this->user->createToken($userdata);
